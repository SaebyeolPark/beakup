...
iframe{ left:50%; margin-left: -687px; position: relative; }
...
<div width= "0px" margin= "auto">
<table class="menu" cellpadding="20px">
<tr>
<td rowspan="3"><img src="/project1/image/<%=product.getName() %>.jpg" width="300px"/></td><td><%=product.getName() %></td>
</tr>
<tr><td><%=product.getPrice() %></td></tr>
<tr><td><%=product.getFabric() %></td></tr>
</table>
</div>
